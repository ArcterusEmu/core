...
void World::LoadConfigSettings(bool reload)
{
    ...
    // Prevent players from accessing GM Island -- Ban or not to ban?
    m_bool_configs[CONFIG_GMISLAND_PLAYERS_ACCESS] = sConfig.GetBoolDefault("GMIsland.PlayersAccess", true);
    m_bool_configs[CONFIG_GMISLAND_BAN_ENABLE] = sConfig.GetBoolDefault("GMIsland.Ban.Enable", false);
    // Prevent players from accessing unused areas -- Ban or not to ban?
    m_bool_configs[CONFIG_PLAYERS_ACCESS_UNUSED_AREA] = sConfig.GetBoolDefault("UnusedAreas.PlayersAccess", true);
    m_bool_configs[CONFIG_UNUSED_AREA_BAN_ENABLE] = sConfig.GetBoolDefault("UnusedAreas.Ban.Enable", false);
