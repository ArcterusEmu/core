...
public:
	...
	struct boss_thorimAI : public BossAI
	{
		...
		void Reset()
		{
			...
			me->SummonCreature(32892, 2135.04f, -310.787f, 438.23f, 0.0f, TEMPSUMMON_MANUAL_DESPAWN);
		...
		void JustDied(Unit * victim)
		{
			...
			if (pInstance)
			{
				...
				if (HardMode)
				{
					...
					me->SummonGameObject(RAID_MODE(CACHE_OF_STORMS_HARDMODE_10, CACHE_OF_STORMS_HARDMODE_25), 2134.58f, -286.908f, 419.495f, 1.55988f, 0.0f, 0.0f, 0.7f, 0.7f, 604800);
				}
				else
				{
					me->SummonGameObject(RAID_MODE(CACHE_OF_STORMS_10, CACHE_OF_STORMS_25), 2134.58f, -286.908f, 419.495f, 1.55988f, 0.0f, 0.0f, 0.7f, 0.7f, 604800);
				}
			}
		}
