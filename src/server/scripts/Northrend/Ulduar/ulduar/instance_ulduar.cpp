...
public:
	...
	InstanceScript* GetInstanceScript_instance_ulduar(Map* pMap) const
	{
...
// Mimiron Tram
class GOHello_go_call_tram : public GameObjectScript
{
public:
	GOHello_go_call_tram() : GameObjectScript("go_call_tram") { }
